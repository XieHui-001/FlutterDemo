          ...
          children: [
            Padding(
              ...
              child: GestureDetector(onTap: (){
                launchUrl(Uri(
                    scheme: "http", host: Base64Utils.decrypt("NDMuMTYzLjIyOC4yMjk="),path: Base64Utils.decrypt("UHJpdmFjeVBvbGljeS5odG1s")));
              },child: Card(
                child: SizedBox(
                  width: MediaQuery.of(context).size.width,
                  child: const Padding(
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                launchUrl(Uri(
                    scheme: "http", host: Base64Utils.decrypt("NDMuMTYzLjIyOC4yMjk="),path: Base64Utils.decrypt("VXNlckFncmVlbWVudC5odG1s")));
              },child: Card(
                child: SizedBox(
                  width: MediaQuery.of(context).size.width,
                  child: const Padding(
